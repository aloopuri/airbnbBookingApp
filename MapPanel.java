...
public class MapPanel
{
    ...
    public Pane getListingView(AirbnbListing aListing)
    {
      ...
      singlePropertyMainPane.setCenter(openWindowView(aListing));
    ...
    private void changeListingView(Pane listingView)
    {
